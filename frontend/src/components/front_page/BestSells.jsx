...
const BestSells = () => {
    ...
    return (
        ...
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-xl font-semibold">Best Sellers Test Figures now</h2>
  ...
  {products.map((product, i) => (
    <div className='border border-gray-200 rounded-lg overflow-hidden transition-shadow duration-300'>
